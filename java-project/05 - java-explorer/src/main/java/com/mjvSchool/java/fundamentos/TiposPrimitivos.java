...
public class TiposPrimitivos {
	...
	public static void main(String[] args) {
		...
		long pontosAcumulados = 3_134_231_11;
		System.out.println(pontosAcumulados);
		//Por que o "L", para indicar que e variável é do tipo long. Usar o L maisculo para não confundir com o numero
		

		float salario = 11_445.44F;
		System.out.println(salario);
		// Por que o "F" no final? para indicar o java que é do tipo Float. E por que? Porque o padrão é do tipo double.
