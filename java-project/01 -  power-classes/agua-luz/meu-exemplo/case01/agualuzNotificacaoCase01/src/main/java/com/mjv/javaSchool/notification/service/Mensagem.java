...
public class Mensagem {
	public void gerarMensagem (GeradorContrato contrato) {
		...
		sb.append(String.format(", Informamos que conforme contrato com protocolo de número %s está \nagendado para a data\\hora", contrato.getNumProtocolo()));
		...
		sb.append(String.format(" %sh a instalação do serviço de %s com taxa de valor R$ %s em sua residência localizada \nno endereço abaixo:", dataFormatada,contrato.getServico(),valorFormatadoBr));
